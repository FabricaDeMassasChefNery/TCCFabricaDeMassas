...
\input{editaveis/abordagemDoProblema}
\input{editaveis/partesEnvolvidas}
\input{editaveis/perspectivaDoProduto}
\input{editaveis/principaisCapacidades}
\input{editaveis/restricoesDoProjeto}
